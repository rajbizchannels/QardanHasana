...
VALUES
  ('gg111111-1111-1111-1111-111111111111', '77777777-7777-7777-7777-777777777777', 'GR00000001', 150000, 1, 'active', '11111111-1111-1111-1111-111111111111')
ON CONFLICT DO NOTHING;
...
VALUES
  ('ll111111-1111-1111-1111-111111111111', 'LN00000001',
  ...
  ('ll222222-2222-2222-2222-222222222222', 'LN00000002',
  ...
  ('ll333333-3333-3333-3333-333333333333', 'LN00000003',
...
VALUES
  ('tt111111-1111-1111-1111-111111111111', 'TXN00000001', 'loan_disbursement', 150000, 'INR',
   'Loan disbursement for LN00000001',
   '33333333-3333-3333-3333-333333333333', '44444444-4444-4444-4444-444444444444',
   'll111111-1111-1111-1111-111111111111',
  ...
  ('tt222222-2222-2222-2222-222222222222', 'TXN00000002', 'loan_repayment', 5000, 'INR',
  ...
  ('tt333333-3333-3333-3333-333333333333', 'TXN00000003', 'loan_repayment', 5000, 'INR',
  ...
  ('tt444444-4444-4444-4444-444444444444', 'TXN00000004', 'loan_disbursement', 200000, 'INR',
   'Loan disbursement for LN00000002',
   '33333333-3333-3333-3333-333333333333', '55555555-5555-5555-5555-555555555555',
   'll222222-2222-2222-2222-222222222222',
  ...
  ('tt555555-5555-5555-5555-555555555555', 'TXN00000005', 'loan_repayment', 8000, 'INR',
  ...
  ('tt666666-6666-6666-6666-666666666666', 'TXN00000006', 'loan_repayment', 8000, 'INR',
...
VALUES
  ('33333333-3333-3333-3333-333333333333', 'tt111111-1111-1111-1111-111111111111', 'll111111-1111-1111-1111-111111111111',
   'debit', 150000, 'INR', -150000, 'Loan disbursement to Murtaza Kapasi', 'TXN00000001', '22222222-2222-2222-2222-222222222222'),
  ('44444444-4444-4444-4444-444444444444', 'tt111111-1111-1111-1111-111111111111', 'll111111-1111-1111-1111-111111111111',
   'credit', 150000, 'INR', 150000, 'Loan received from Ibrahim Rangwala', 'TXN00000001', '22222222-2222-2222-2222-222222222222'),
  ('44444444-4444-4444-4444-444444444444', 'tt222222-2222-2222-2222-222222222222', 'll111111-1111-1111-1111-111111111111',
   'debit', 5000, 'INR', 145000, 'Repayment Jan 2024', 'TXN00000002', '22222222-2222-2222-2222-222222222222'),
  ('33333333-3333-3333-3333-333333333333', 'tt222222-2222-2222-2222-222222222222', 'll111111-1111-1111-1111-111111111111',
   'credit', 5000, 'INR', -145000, 'Repayment received from Murtaza', 'TXN00000002', '22222222-2222-2222-2222-222222222222'),
  ('33333333-3333-3333-3333-333333333333', 'tt444444-4444-4444-4444-444444444444', 'll222222-2222-2222-2222-222222222222',
   'debit', 200000, 'INR', -345000, 'Loan disbursement to Zainab Noorani', 'TXN00000004', '22222222-2222-2222-2222-222222222222'),
  ('55555555-5555-5555-5555-555555555555', 'tt444444-4444-4444-4444-444444444444', 'll222222-2222-2222-2222-222222222222',
...
VALUES
  ('transaction', 'tt666666-6666-6666-6666-666666666666',
...
VALUES
  ...
  ('22222222-2222-2222-2222-222222222222', 'LOAN_CREATED', 'loan', 'll111111-1111-1111-1111-111111111111', '127.0.0.1', 'success'),
  ('22222222-2222-2222-2222-222222222222', 'TRANSACTION_CREATED', 'transaction', 'tt111111-1111-1111-1111-111111111111', '127.0.0.1', 'success'),
  ('44444444-4444-4444-4444-444444444444', 'LOGIN', 'user', '44444444-4444-4444-4444-444444444444', '192.168.1.1', 'success'),
  ('55555555-5555-5555-5555-555555555555', 'TRANSACTION_CREATED', 'transaction', 'tt666666-6666-6666-6666-666666666666', '192.168.1.2', 'success')
ON CONFLICT DO NOTHING;
